...
public class TextMenu extends JMenu {
	...
	/**
	 * Ad a submenu with a group of three buttons that can be 
	 * used to control the text justification. You can do the work 
	 * in the file TextMenu.java.
	 * Create a new JMenu named "Justify." To this menu, 
	 * you will add three JRadioButtonMenuItems named "Left", 
	 * "Right", and "Center". To make the radio buttons into an 
	 * actual group, create a ButtonGroup object, and add each 
	 * radio button to the button group. Add the JMenu to the
	 *  menu that is created by the constructor of the TextMenu
	 *   class. You might want to use a makeJustifyMenu method, 
	 *   similar to (but simpler than) the makeFontNameSubmenu 
	 *   method that is already defined in TextMenu.
	 * @return
	 */
	...
	public void setDefaults() {
		...
		//Added to be selected by default to left.
		left.setSelected(true);
	}
