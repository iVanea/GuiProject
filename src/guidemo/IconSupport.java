...
public class IconSupport {
	 ...
	 * return a menu with the same functionality as the toolbar. 
	 * That is, all the Actions from the actions arraylist should 
	 * be added to the menu, just as they were added to the toolbar.
	 *  (Remember that a menu is represented by an object of type 
	 *  JMenu, which can be created, for example, with: 
